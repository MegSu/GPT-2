...
def main(prefix, total_length):
    parser = argparse.ArgumentParser()
    parser.add_argument('--device', default='0,1,2,3', type=str, required=False, help='生成设备')
    parser.add_argument('--length', default=500, type=int, required=False, help='生成长度')
    parser.add_argument('--batch_size', default=1, type=int, required=False, help='生成的batch size')
    parser.add_argument('--nsamples', default=1, type=int, required=False, help='生成几个样本')
    parser.add_argument('--temperature', default=0.9, type=float, required=False, help='生成温度')
    ...
    parser.add_argument('--model_path', default='model/model_epoch10_modern', type=str, required=False, help='模型路径')
    ...
    while True:
        ...
        remove1 = '\n'
        result = [value for value in result if value != remove1]
        ...
        result = result[0:lst[total_length-1]] #擷取使用者輸入的行數
        print(result)
